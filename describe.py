...
def describe():
    columns = {}
    results = {"count": [], "mean": [], "std": [], "min": [], "25%": [], "50%": [], "75%": [], "max": []}
    #read the csv file and store the numeric values in a dictionary where the keys are the column names and the values are lists of numeric values
    try:
    ...
    for header in numeric_columns:
        display_name = (header[:COL_WIDTH-8] + '..') if len(header) > COL_WIDTH-4 else header
